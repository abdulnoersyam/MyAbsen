            ...
            item {
                Column(
                    ...
                    ButtonModel(
                        ...
                        onClick = {
                            isLoading = true
                            viewModel.loginGuruDanKaryawan(viewModel.email.value, viewModel.password.value)
                        },
                        ...
                        LaunchedEffect(loginResult) {
                            when (loginResult) {
                                is ResultState.Success -> {
                                    viewModel.saveSessionGuruDanKaryawan((loginResult as ResultState.Success<UserModel>).data)
